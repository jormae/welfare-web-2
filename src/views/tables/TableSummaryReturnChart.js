...
import { DataContext } from 'src/pages/summary-return-chart'

const TableReturnSummaryChart = () => {
  const summaryReturnCharts = useContext(DataContext)
      ...
      <CardContent>
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 }} aria-label='simple table'>
            ...
            <TableBody>
              {summaryReturnCharts.blogs.map(row => (
                <TableRow key={row.an}>
...
export default TableReturnSummaryChart
