...
import { DataContext } from 'src/pages/reaudit-chart'

const TableReauditChart = () => {
  const reauditCharts = useContext(DataContext)
...
export default TableReauditChart
