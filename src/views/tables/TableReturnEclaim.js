...
import { DataContext } from 'src/pages/return-eclaim'

const TableReturnEclaim = () => {
  const returnEclaim = useContext(DataContext)
...
export default TableReturnEclaim
