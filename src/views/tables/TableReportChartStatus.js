            ...
            <TableBody>
              {reportCharts.blogs.map(row => (
                <TableRow key={row.YEAR_MONTH}>
                  ...
                  <TableCell align='left'>{row.COLLECTED_DATE}</TableCell>
                  <TableCell align='left'>{row.START_SUMMARY_DATE}</TableCell>
                  {/* <TableCell align='center'>{moment(row.dischargeDate).format('L')}</TableCell> */}
                  <TableCell align='left'>{row.RETURN_SUMMARY_DATE}</TableCell>
                  <TableCell align='left'>{row.RETURN_AUDIT_DATE}</TableCell>
                  <TableCell align='left'>{row.REAUDIT_DATE}</TableCell>
                  <TableCell align='left'>{row.SUBMIT_ECLAIM_DATE}</TableCell>
                  <TableCell align='left'>{row.RETURN_ECLAIM_DATE}</TableCell>
                  <TableCell align='left'>{row.STOCK_DATE}</TableCell>
                  <TableCell align='center'>
                    <Link href={`/detail-chart/${row.YEAR_MONTH}`} color='success'>
