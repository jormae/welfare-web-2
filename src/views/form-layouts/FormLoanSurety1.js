  ...
  return (
          ...
          <Grid container spacing={2} sx={{pl: 15, pr:15}}>
            ...
            <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'left' }}>
                ...
                คำให้การค้ำประกัน ข้าพเจ้า (นาย, นาง, นางสาว) {loanDetail?.firstReferenceName} เลขที่บัตรประชาชน {loanDetail?.firstReferenceId} โทรศัพท์ {loanDetail?.firstReferenceContactNo}
            ...
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center'}}>
                <Typography variant='body2'>( {loanDetail?.firstReferenceName} )</Typography>
            </Grid>
            <Grid item xs={6}/>
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center', mt:3}}>
            ...
            <Grid item xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'left' }}>
                <Typography variant='body2' sx={{lineHeight:2, justifyContent:'justify'}} paragraph="true">
                ข้าพเจ้า (นาย, นาง, นางสาว) {loanDetail?.firstSpouseName} เลขที่บัตรประชาชน {loanDetail?.firstSpouseNationalId} โทรศัพท์ {loanDetail?.firstSpouseContactNo}
                &nbsp; คู่สมรสของ {loanDetail?.firstReferenceName} ยินยอมให้ (นาย, นาง, นางสาว) {loanDetail?.firstReferenceName} 
            ...
            <Grid item xs={6}/>
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center'}}>
                <Typography variant='body2'>( {loanDetail?.firstSpouseName} )</Typography>
            </Grid>
            <Grid item xs={6}/>
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'center', mt:3}}>
                <Typography variant='body2'>ลงชื่อ......................................พยาน</Typography>
